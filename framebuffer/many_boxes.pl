...
# Many boxes demonstration using Graphics::Framebuffer and MCE::Hobo.
...
use MCE::Hobo 1.849; # minimum version requirement
use MCE::Shared;
...
Keep older boxes on the screen.
