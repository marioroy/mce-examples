...
# Many lines demonstration using Graphics::Framebuffer and MCE::Child.
...
The number of lines per set; default 50.

=item B<-noerase>

Keep older lines on the screen.
